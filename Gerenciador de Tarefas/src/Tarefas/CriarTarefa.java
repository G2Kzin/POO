...
public class CriarTarefa {
    ...
    public void removerTarefa(CriarTarefa tarefa){
        ...
        if(opcao.equalsIgnoreCase("sim")){
            exibir();
            System.out.println("Digite o nome de umas das tarefas para remover");
            String nome = sc.nextLine();
    ...
    public void tarefasConcluidas(CriarTarefa tarefa) {
        System.out.println("Deseja colocar uma tarefa como concluida? ");
        String opcao = sc.nextLine();
        ...
        if (opcao.equalsIgnoreCase("sim")) {
            ...
            while (iterator.hasNext()) {
                ...
                if (t.getNomeTarefa().equals(concluida)) {
                    ...
                    t.setConcluida(true);
                    tarefasFinalizadas++;
                    System.out.println("A tarefa: " + t.getNomeTarefa() + " foi marcada como concluida.");
                }
            }
            if (!tarefaEncontrada) {
